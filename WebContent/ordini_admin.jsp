...
.productcard {
    ...
    flex: 1 1 calc(100% / 4 - 40px); /* Assicura il wrapping su schermi più piccoli */
}
...
@media (max-width: 600px) {
    .container {
        padding: 10px; /* Riduce il padding per piccoli schermi */
        gap: 10px; /* Riduce lo spazio tra i productcard */
    }
...
@media (min-width: 601px) and (max-width: 900px) {
    .productcard {
        ...
        max-width: 50%;
        padding: 15px; /* Ridotto per adattarsi meglio */
    }
}
...
<div class="content">
    <div class="container" style="justify-content: center">
        ...
        <div class="productcard">
            <a href="./ShowOrdine.jsp?ordine=<%= ordine %>">Ordine N: <%= ordine %> User: <%= od.get_ordine_user(ordine) %> Data: <%= od.get_ordine_data(ordine) %></a>
        </div>
        <%
                }
            }
